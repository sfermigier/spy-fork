...
class MatchSymbol:
    ...
    def __init__(self, name: str, color: Color, level: int = 0, fqn: Any = MISSING):
        self.name = name
        self.color = color
        self.level = level
        self.fqn = fqn
    ...
    def __eq__(self, sym: object) -> bool:
        ...
        return (
            ...
            and (self.fqn is MISSING or self.fqn == sym.fqn)
        )
...
class TestScopeAnalyzer:
    ...
    def test_import(self):
        ...
        scope = scopes.by_module()
        assert scope._symbols == {
            "my_int": MatchSymbol("my_int", "blue", fqn=FQN.parse("builtins::i32")),
        }
